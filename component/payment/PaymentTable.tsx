...
import { Delete, Block, CheckCircle, Chevron, ChevronNext,Instruction } from "@/svg/Action";
...
//                             <Block />
//                           </span>
//                           <span className="pb-1 text-sm">Block Subscription</span>
//                         </div>
//                         <div className="flex items-center gap-2">
//                           <span className="pl-1">
//                             <Delete />
//                           </span>
//                           <span className="pb-1 text-sm">Delete Subscription</span>
//                         </div>
//                       </div>
//                     </PopoverContent>
//                   </Popover>
...
export const PaymentTable = ({ search, duration }: Filter) => {
  ...
  const filteredData = useMemo(() => {
    return data.filter((item) => {
      ...
      const isSearchMatch =
        item.name.toLowerCase().includes(search.toLowerCase()) || item.amount.toString().includes(search.toLowerCase()) || item.lastactive.toString().includes(search.toLowerCase()) || item.duration.toString().includes(search.toLowerCase());
            ...
            {paginatedData.map((item, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Status */}
                  <TableCell
                    className={`py-4 text-center ${isBlocked ? "opacity-30" : ""}`}
                  >
                    <div className="flex justify-center">
                      <span
                        className={`px-3 py-1 rounded-full text-xs font-semibold mb-1 bg-[#BDBDBD]`}
